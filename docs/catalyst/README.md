...
| Milestone 5 | 3. Demo video | A demonstration of the delivered front end | [Demonstration videos](./demo/) — fifteen use-case recordings, plus a 4 min 26 s combined walkthrough | Met |
...
| Milestone 5 | 3. デモ動画 | 完成したフロントエンドのデモンストレーション | [デモ動画](./demo/) — ユースケース別15本と、4分26秒の通し版 | 充足 |
