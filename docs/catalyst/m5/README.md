...
Project Catalyst F12, Project ID 1200088. Code as of `df68a9a` (2026-09-07).
...
- Either link, on a phone, a tablet or a desktop browser
- [Trying the application](#trying-the-application)
...
- To be carried in each video's description on publication
...
Project Catalyst F12、Project ID 1200088。`df68a9a`（2026-09-07）時点のコード。
