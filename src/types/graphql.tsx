...
export type GqlCreateReservationMutation = {
  __typename?: "Mutation";
  reservationCreate?:
    | { __typename: "MissingTicketIdsError"; code: GqlErrorCode; message: string }
    | { __typename: "ReservationAdvanceBookingRequiredError"; code: GqlErrorCode; message: string }
    | {
        __typename?: "ReservationCreateSuccess";
    ...
    | { __typename: "ReservationNotAcceptedError"; code: GqlErrorCode; message: string }
    | { __typename: "SlotNotScheduledError"; code: GqlErrorCode; message: string }
    | {
        __typename: "TicketParticipantMismatchError";
        code: GqlErrorCode;
        message: string;
