...
export type GqlCommunityFieldsFragment = { __typename?: 'Community', id: string, name?: string | null, image?: string | null };

export type GqlGetCommunitiesQueryVariables = Exact<{ [key: string]: never; }>;


export type GqlGetCommunitiesQuery = { __typename?: 'Query', communities: { __typename?: 'CommunitiesConnection', totalCount: number, edges?: Array<{ __typename?: 'CommunityEdge', node?: { __typename?: 'Community', id: string, name?: string | null } | null }> | null } };
...
export type GqlGetCommunityQuery = { __typename?: 'Query', community?: { __typename?: 'Community', id: string, name?: string | null } | null };

export type GqlIdentityFieldsFragment = { __typename?: 'Identity', uid: string, platform?: GqlIdentityPlatform | null, createdAt?: Date | null, updatedAt?: Date | null };
...
export type GqlUserSignUpMutation = { __typename?: 'Mutation', userSignUp?: { __typename?: 'CurrentUserPayload', user?: { __typename?: 'User', id: string, name: string } | null } | null };
...
export type GqlStorePhoneAuthTokenMutation = { __typename?: 'Mutation', storePhoneAuthToken?: { __typename?: 'StorePhoneAuthTokenPayload', success: boolean, expiresAt?: Date | null } | null };
...
export type GqlLinkPhoneAuthMutation = { __typename?: 'Mutation', linkPhoneAuth?: { __typename?: 'LinkPhoneAuthPayload', success: boolean, user?: { __typename?: 'User', id: string, name: string } | null } | null };

export type GqlCurrentUserQueryVariables = Exact<{ [key: string]: never; }>;


export type GqlCurrentUserQuery = { __typename?: 'Query', currentUser?: { __typename?: 'CurrentUserPayload', user?: { __typename?: 'User', id: string, name: string, memberships?: Array<{ __typename?: 'Membership', role: GqlRole, status: GqlMembershipStatus, headline?: string | null, bio?: string | null, reason: GqlMembershipStatusReason, user?: { __typename?: 'User', id: string, name: string } | null, community?: { __typename?: 'Community', id: string, name?: string | null } | null }> | null } | null } | null };

export type GqlMembershipFieldsFragment = { __typename?: 'Membership', headline?: string | null, bio?: string | null, role: GqlRole, status: GqlMembershipStatus, reason: GqlMembershipStatusReason };

export type GqlHostedGeoFieldsFragment = { __typename?: 'MembershipHostedMetrics', totalParticipantCount: number, geo: Array<{ __typename?: 'MembershipParticipationLocation', placeId: string, placeName: string, placeImage: string, latitude: any, longitude: any, address: string }> };
...
export type GqlGetSingleMembershipQuery = { __typename?: 'Query', membership?: { __typename?: 'Membership', headline?: string | null, bio?: string | null, role: GqlRole, status: GqlMembershipStatus, reason: GqlMembershipStatusReason, participationView?: { __typename?: 'MembershipParticipationView', hosted: { __typename?: 'MembershipHostedMetrics', totalParticipantCount: number, geo: Array<{ __typename?: 'MembershipParticipationLocation', placeId: string, placeName: string, placeImage: string, latitude: any, longitude: any, address: string }> } } | null, user?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null, articlesAboutMe?: Array<{ __typename?: 'Article', id: string, title: string, body?: string | null, introduction: string, thumbnail?: any | null, category: GqlArticleCategory, publishStatus: GqlPublishStatus, publishedAt?: Date | null }> | null, opportunitiesCreatedByMe?: Array<{ __typename?: 'Opportunity', id: string, title: string, description: string, body?: string | null, images?: Array<string> | null, category: GqlOpportunityCategory, publishStatus: GqlPublishStatus, isReservableWithTicket?: boolean | null, requireApproval: boolean, feeRequired?: number | null, pointsToEarn?: number | null, earliestReservableAt?: Date | null, community?: { __typename?: 'Community', id: string, name?: string | null, image?: string | null } | null }> | null } | null, community?: { __typename?: 'Community', id: string, name?: string | null, image?: string | null } | null } | null };
...
export type GqlGetMembershipListQuery = { __typename?: 'Query', memberships: { __typename?: 'MembershipsConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null }, edges?: Array<{ __typename?: 'MembershipEdge', cursor: string, node?: { __typename?: 'Membership', hostOpportunityCount?: number | null, headline?: string | null, bio?: string | null, role: GqlRole, status: GqlMembershipStatus, reason: GqlMembershipStatusReason, participationView?: { __typename?: 'MembershipParticipationView', hosted: { __typename?: 'MembershipHostedMetrics', totalParticipantCount: number, geo: Array<{ __typename?: 'MembershipParticipationLocation', placeId: string, placeName: string, placeImage: string, latitude: any, longitude: any, address: string }> } } | null, user?: { __typename?: 'User', id: string, image?: string | null, name: string, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null, articlesAboutMe?: Array<{ __typename?: 'Article', id: string, title: string, body?: string | null, introduction: string, thumbnail?: any | null, category: GqlArticleCategory, publishStatus: GqlPublishStatus, publishedAt?: Date | null }> | null } | null, community?: { __typename?: 'Community', id: string, name?: string | null, image?: string | null } | null } | null } | null> | null } };

export type GqlUserFieldsFragment = { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null };

export type GqlUserPortfolioFieldsFragment = { __typename?: 'Portfolio', id: string, title: string, thumbnailUrl?: string | null, source: GqlPortfolioSource, category: GqlPortfolioCategory, date: Date, reservationStatus?: GqlReservationStatus | null, place?: { __typename?: 'Place', id: string, name: string, address: string, latitude: any, longitude: any, city?: { __typename?: 'City', code: string, name: string, state?: { __typename?: 'State', code: string, countryCode: string, name: string } | null } | null } | null, participants?: Array<{ __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null }> | null };
...
export type GqlUpdateMyProfileMutation = { __typename?: 'Mutation', userUpdateMyProfile?: { __typename?: 'UserUpdateProfileSuccess', user?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null, slug?: string | null } | null } | null };
...
export type GqlGetUserFlexibleQuery = { __typename?: 'Query', user?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null, portfolios?: Array<{ __typename?: 'Portfolio', id: string, title: string, thumbnailUrl?: string | null, source: GqlPortfolioSource, category: GqlPortfolioCategory, date: Date, reservationStatus?: GqlReservationStatus | null, place?: { __typename?: 'Place', id: string, name: string, address: string, latitude: any, longitude: any, city?: { __typename?: 'City', code: string, name: string, state?: { __typename?: 'State', code: string, countryCode: string, name: string } | null } | null } | null, participants?: Array<{ __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null }> | null }> | null, wallets?: Array<{ __typename?: 'Wallet', id: string, type: GqlWalletType, tickets?: Array<{ __typename?: 'Ticket', id: string, reason: GqlTicketStatusReason, status: GqlTicketStatus }> | null, currentPointView?: { __typename?: 'CurrentPointView', currentPoint: number } | null }> | null, opportunitiesCreatedByMe?: Array<{ __typename?: 'Opportunity', id: string, title: string, description: string, body?: string | null, images?: Array<string> | null, category: GqlOpportunityCategory, publishStatus: GqlPublishStatus, isReservableWithTicket?: boolean | null, requireApproval: boolean, feeRequired?: number | null, pointsToEarn?: number | null, earliestReservableAt?: Date | null, community?: { __typename?: 'Community', id: string, name?: string | null, image?: string | null } | null, place?: { __typename?: 'Place', id: string, name: string, address: string, latitude: any, longitude: any, city?: { __typename?: 'City', code: string, name: string, state?: { __typename?: 'State', code: string, countryCode: string, name: string } | null } | null } | null }> | null } | null };
...
export type GqlGetUserWalletQuery = { __typename?: 'Query', user?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null, wallets?: Array<{ __typename?: 'Wallet', id: string, type: GqlWalletType, transactions?: Array<{ __typename?: 'Transaction', id: string, reason: GqlTransactionReason, fromPointChange?: number | null, toPointChange?: number | null, createdAt?: Date | null, fromWallet?: { __typename?: 'Wallet', id: string, type: GqlWalletType, user?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null } | null, currentPointView?: { __typename?: 'CurrentPointView', currentPoint: number } | null } | null, toWallet?: { __typename?: 'Wallet', id: string, type: GqlWalletType, user?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null } | null, currentPointView?: { __typename?: 'CurrentPointView', currentPoint: number } | null } | null }> | null, tickets?: Array<{ __typename?: 'Ticket', id: string, reason: GqlTicketStatusReason, status: GqlTicketStatus, utility?: { __typename?: 'Utility', id: string, name?: string | null, description?: string | null, images?: Array<string> | null, publishStatus: GqlPublishStatus, pointsRequired: number } | null }> | null, currentPointView?: { __typename?: 'CurrentPointView', currentPoint: number } | null }> | null } | null };

export type GqlWalletFieldsFragment = { __typename?: 'Wallet', id: string, type: GqlWalletType, currentPointView?: { __typename?: 'CurrentPointView', currentPoint: number } | null };
...
export type GqlGetWalletsWithTransactionQuery = { __typename?: 'Query', wallets: { __typename?: 'WalletsConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null }, edges?: Array<{ __typename?: 'WalletEdge', cursor: string, node?: { __typename?: 'Wallet', id: string, type: GqlWalletType, transactions?: Array<{ __typename?: 'Transaction', id: string, reason: GqlTransactionReason, fromPointChange?: number | null, toPointChange?: number | null, createdAt?: Date | null, fromWallet?: { __typename?: 'Wallet', id: string, type: GqlWalletType, user?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null } | null, currentPointView?: { __typename?: 'CurrentPointView', currentPoint: number } | null } | null, toWallet?: { __typename?: 'Wallet', id: string, type: GqlWalletType, user?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null } | null, currentPointView?: { __typename?: 'CurrentPointView', currentPoint: number } | null } | null }> | null, currentPointView?: { __typename?: 'CurrentPointView', currentPoint: number } | null } | null } | null> | null } };
...
export type GqlGetWalletsWithTicketQuery = { __typename?: 'Query', wallets: { __typename?: 'WalletsConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null }, edges?: Array<{ __typename?: 'WalletEdge', cursor: string, node?: { __typename?: 'Wallet', id: string, type: GqlWalletType, tickets?: Array<{ __typename?: 'Ticket', id: string, reason: GqlTicketStatusReason, status: GqlTicketStatus, utility?: { __typename?: 'Utility', id: string, name?: string | null, description?: string | null, images?: Array<string> | null, publishStatus: GqlPublishStatus, pointsRequired: number } | null }> | null, currentPointView?: { __typename?: 'CurrentPointView', currentPoint: number } | null } | null } | null> | null } };

export type GqlArticleFieldsFragment = { __typename?: 'Article', id: string, title: string, body?: string | null, introduction: string, thumbnail?: any | null, category: GqlArticleCategory, publishStatus: GqlPublishStatus, publishedAt?: Date | null };
...
export type GqlGetArticlesQuery = { __typename?: 'Query', articles: { __typename?: 'ArticlesConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null }, edges?: Array<{ __typename?: 'ArticleEdge', cursor: string, node?: { __typename?: 'Article', id: string, title: string, body?: string | null, introduction: string, thumbnail?: any | null, category: GqlArticleCategory, publishStatus: GqlPublishStatus, publishedAt?: Date | null, authors?: Array<{ __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null }> | null } | null } | null> | null } };
...
export type GqlGetArticleQuery = { __typename?: 'Query', article?: { __typename?: 'Article', id: string, title: string, body?: string | null, introduction: string, thumbnail?: any | null, category: GqlArticleCategory, publishStatus: GqlPublishStatus, publishedAt?: Date | null, authors?: Array<{ __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null, opportunitiesCreatedByMe?: Array<{ __typename?: 'Opportunity', id: string, title: string, description: string, body?: string | null, images?: Array<string> | null, category: GqlOpportunityCategory, publishStatus: GqlPublishStatus, isReservableWithTicket?: boolean | null, requireApproval: boolean, feeRequired?: number | null, pointsToEarn?: number | null, earliestReservableAt?: Date | null, place?: { __typename?: 'Place', id: string, name: string, address: string, latitude: any, longitude: any, city?: { __typename?: 'City', code: string, name: string, state?: { __typename?: 'State', code: string, countryCode: string, name: string } | null } | null } | null }> | null }> | null, relatedUsers?: Array<{ __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null }> | null } | null, articles: { __typename?: 'ArticlesConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null }, edges?: Array<{ __typename?: 'ArticleEdge', cursor: string, node?: { __typename?: 'Article', id: string, title: string, body?: string | null, introduction: string, thumbnail?: any | null, category: GqlArticleCategory, publishStatus: GqlPublishStatus, publishedAt?: Date | null, authors?: Array<{ __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null }> | null } | null } | null> | null } };

export type GqlEvaluationFieldsFragment = { __typename?: 'Evaluation', id: string, comment?: string | null, credentialUrl?: string | null, status: GqlEvaluationStatus, createdAt?: Date | null, updatedAt?: Date | null, issuedAt?: Date | null };

export type GqlGetEvaluationsQueryVariables = Exact<{ [key: string]: never; }>;


export type GqlGetEvaluationsQuery = { __typename?: 'Query', evaluations: { __typename?: 'EvaluationsConnection', totalCount: number, edges: Array<{ __typename?: 'EvaluationEdge', node?: { __typename?: 'Evaluation', id: string } | null }> } };
...
export type GqlGetEvaluationQuery = { __typename?: 'Query', evaluation?: { __typename?: 'Evaluation', id: string } | null };

export type GqlOpportunityFieldsFragment = { __typename?: 'Opportunity', id: string, title: string, description: string, body?: string | null, images?: Array<string> | null, category: GqlOpportunityCategory, publishStatus: GqlPublishStatus, isReservableWithTicket?: boolean | null, requireApproval: boolean, feeRequired?: number | null, pointsToEarn?: number | null, earliestReservableAt?: Date | null };
...
export type GqlGetOpportunitiesQuery = { __typename?: 'Query', opportunities: { __typename?: 'OpportunitiesConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', startCursor?: string | null, endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean }, edges: Array<{ __typename?: 'OpportunityEdge', cursor: string, node?: { __typename?: 'Opportunity', id: string, title: string, description: string, body?: string | null, images?: Array<string> | null, category: GqlOpportunityCategory, publishStatus: GqlPublishStatus, isReservableWithTicket?: boolean | null, requireApproval: boolean, feeRequired?: number | null, pointsToEarn?: number | null, earliestReservableAt?: Date | null, community?: { __typename?: 'Community', id: string, name?: string | null, image?: string | null } | null, slots?: Array<{ __typename?: 'OpportunitySlot', id: string, hostingStatus: GqlOpportunitySlotHostingStatus, startsAt: Date, endsAt: Date, capacity?: number | null, remainingCapacity?: number | null }> | null, place?: { __typename?: 'Place', id: string, name: string, address: string, latitude: any, longitude: any, city?: { __typename?: 'City', code: string, name: string, state?: { __typename?: 'State', code: string, countryCode: string, name: string } | null } | null } | null } | null }> } };
...
export type GqlGetOpportunityQuery = { __typename?: 'Query', opportunity?: { __typename?: 'Opportunity', id: string, title: string, description: string, body?: string | null, images?: Array<string> | null, category: GqlOpportunityCategory, publishStatus: GqlPublishStatus, isReservableWithTicket?: boolean | null, requireApproval: boolean, feeRequired?: number | null, pointsToEarn?: number | null, earliestReservableAt?: Date | null, community?: { __typename?: 'Community', id: string, name?: string | null, image?: string | null } | null, place?: { __typename?: 'Place', id: string, name: string, address: string, latitude: any, longitude: any, city?: { __typename?: 'City', code: string, name: string, state?: { __typename?: 'State', code: string, countryCode: string, name: string } | null } | null } | null, slots?: Array<{ __typename?: 'OpportunitySlot', id: string, hostingStatus: GqlOpportunitySlotHostingStatus, startsAt: Date, endsAt: Date, capacity?: number | null, remainingCapacity?: number | null, reservations?: Array<{ __typename?: 'Reservation', id: string, status: GqlReservationStatus, participations?: Array<{ __typename?: 'Participation', id: string, source?: GqlSource | null, status: GqlParticipationStatus, reason: GqlParticipationStatusReason, images?: Array<string> | null, description?: string | null, user?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null } | null }> | null }> | null }> | null, createdByUser?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null, articlesAboutMe?: Array<{ __typename?: 'Article', id: string, title: string, body?: string | null, introduction: string, thumbnail?: any | null, category: GqlArticleCategory, publishStatus: GqlPublishStatus, publishedAt?: Date | null }> | null, opportunitiesCreatedByMe?: Array<{ __typename?: 'Opportunity', id: string, title: string, description: string, body?: string | null, images?: Array<string> | null, category: GqlOpportunityCategory, publishStatus: GqlPublishStatus, isReservableWithTicket?: boolean | null, requireApproval: boolean, feeRequired?: number | null, pointsToEarn?: number | null, earliestReservableAt?: Date | null, community?: { __typename?: 'Community', id: string, name?: string | null, image?: string | null } | null, slots?: Array<{ __typename?: 'OpportunitySlot', id: string, hostingStatus: GqlOpportunitySlotHostingStatus, startsAt: Date, endsAt: Date, capacity?: number | null, remainingCapacity?: number | null, reservations?: Array<{ __typename?: 'Reservation', id: string, status: GqlReservationStatus, participations?: Array<{ __typename?: 'Participation', id: string, source?: GqlSource | null, status: GqlParticipationStatus, reason: GqlParticipationStatusReason, images?: Array<string> | null, description?: string | null, user?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null } | null }> | null }> | null }> | null }> | null } | null } | null };
...
export type GqlSearchOpportunitiesQuery = { __typename?: 'Query', opportunities: { __typename?: 'OpportunitiesConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', startCursor?: string | null, endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean }, edges: Array<{ __typename?: 'OpportunityEdge', cursor: string, node?: { __typename?: 'Opportunity', id: string, title: string, description: string, body?: string | null, images?: Array<string> | null, category: GqlOpportunityCategory, publishStatus: GqlPublishStatus, isReservableWithTicket?: boolean | null, requireApproval: boolean, feeRequired?: number | null, pointsToEarn?: number | null, earliestReservableAt?: Date | null, community?: { __typename?: 'Community', id: string, name?: string | null, image?: string | null } | null, place?: { __typename?: 'Place', id: string, name: string, address: string, latitude: any, longitude: any, city?: { __typename?: 'City', code: string, name: string, state?: { __typename?: 'State', code: string, countryCode: string, name: string } | null } | null } | null, slots?: Array<{ __typename?: 'OpportunitySlot', id: string, hostingStatus: GqlOpportunitySlotHostingStatus, startsAt: Date, endsAt: Date, capacity?: number | null, remainingCapacity?: number | null, reservations?: Array<{ __typename?: 'Reservation', id: string, status: GqlReservationStatus, participations?: Array<{ __typename?: 'Participation', id: string, source?: GqlSource | null, status: GqlParticipationStatus, reason: GqlParticipationStatusReason, images?: Array<string> | null, description?: string | null, user?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null } | null }> | null }> | null }> | null } | null }> } };

export type GqlOpportunitySlotFieldsFragment = { __typename?: 'OpportunitySlot', id: string, hostingStatus: GqlOpportunitySlotHostingStatus, startsAt: Date, endsAt: Date, capacity?: number | null, remainingCapacity?: number | null };
...
export type GqlGetOpportunitySlotsQuery = { __typename?: 'Query', opportunitySlots: { __typename?: 'OpportunitySlotsConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', startCursor?: string | null, endCursor?: string | null, hasNextPage: boolean, hasPreviousPage: boolean }, edges?: Array<{ __typename?: 'OpportunitySlotEdge', cursor: string, node?: { __typename?: 'OpportunitySlot', id: string, hostingStatus: GqlOpportunitySlotHostingStatus, startsAt: Date, endsAt: Date, capacity?: number | null, remainingCapacity?: number | null, opportunity?: { __typename?: 'Opportunity', id: string, title: string, description: string, body?: string | null, images?: Array<string> | null, category: GqlOpportunityCategory, publishStatus: GqlPublishStatus, isReservableWithTicket?: boolean | null, requireApproval: boolean, feeRequired?: number | null, pointsToEarn?: number | null, earliestReservableAt?: Date | null } | null } | null } | null> | null } };
...
export type GqlGetOpportunitySlotQuery = { __typename?: 'Query', opportunitySlot?: { __typename?: 'OpportunitySlot', id: string } | null };

export type GqlParticipationFieldsFragment = { __typename?: 'Participation', id: string, source?: GqlSource | null, status: GqlParticipationStatus, reason: GqlParticipationStatusReason, images?: Array<string> | null, description?: string | null };

export type GqlGetParticipationsQueryVariables = Exact<{ [key: string]: never; }>;


export type GqlGetParticipationsQuery = { __typename?: 'Query', participations: { __typename?: 'ParticipationsConnection', totalCount: number, edges: Array<{ __typename?: 'ParticipationEdge', node?: { __typename?: 'Participation', id: string } | null }> } };
...
export type GqlGetParticipationQuery = { __typename?: 'Query', participation?: { __typename?: 'Participation', id: string, source?: GqlSource | null, status: GqlParticipationStatus, reason: GqlParticipationStatusReason, images?: Array<string> | null, description?: string | null, reservation?: { __typename?: 'Reservation', id: string, status: GqlReservationStatus, opportunitySlot?: { __typename?: 'OpportunitySlot', id: string, hostingStatus: GqlOpportunitySlotHostingStatus, startsAt: Date, endsAt: Date, capacity?: number | null, remainingCapacity?: number | null, opportunity?: { __typename?: 'Opportunity', id: string, title: string, description: string, body?: string | null, images?: Array<string> | null, category: GqlOpportunityCategory, publishStatus: GqlPublishStatus, isReservableWithTicket?: boolean | null, requireApproval: boolean, feeRequired?: number | null, pointsToEarn?: number | null, earliestReservableAt?: Date | null, community?: { __typename?: 'Community', id: string, name?: string | null, image?: string | null } | null, createdByUser?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null } | null, place?: { __typename?: 'Place', id: string, name: string, address: string, latitude: any, longitude: any, city?: { __typename?: 'City', code: string, name: string, state?: { __typename?: 'State', code: string, countryCode: string, name: string } | null } | null } | null } | null } | null } | null, statusHistories?: Array<{ __typename?: 'ParticipationStatusHistory', id: string, status: GqlParticipationStatus, reason: GqlParticipationStatusReason, createdAt?: Date | null, createdByUser?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null } | null }> | null, user?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null } | null } | null };

export type GqlReservationFieldsFragment = { __typename?: 'Reservation', id: string, status: GqlReservationStatus };
...
export type GqlCreateReservationMutation = { __typename?: 'Mutation', reservationCreate?: { __typename: 'MissingTicketIdsError', message: string } | { __typename: 'ReservationAdvanceBookingRequiredError', message: string } | { __typename?: 'ReservationCreateSuccess', reservation: { __typename?: 'Reservation', id: string, status: GqlReservationStatus } } | { __typename: 'ReservationFullError', message: string, capacity: number, requested: number } | { __typename: 'ReservationNotAcceptedError', message: string } | { __typename: 'SlotNotScheduledError', message: string } | { __typename: 'TicketParticipantMismatchError', message: string, ticketCount: number, participantCount: number } | null };
...
export type GqlCancelReservationMutation = { __typename?: 'Mutation', reservationCancel?: { __typename?: 'AlreadyJoinedError' } | { __typename?: 'NoAvailableParticipationSlotsError' } | { __typename?: 'ReservationCancellationTimeoutError' } | { __typename?: 'ReservationSetStatusSuccess', reservation: { __typename?: 'Reservation', id: string, status: GqlReservationStatus } } | null };

export type GqlGetReservationsQueryVariables = Exact<{ [key: string]: never; }>;


export type GqlGetReservationsQuery = { __typename?: 'Query', reservations: { __typename?: 'ReservationsConnection', totalCount: number, edges: Array<{ __typename?: 'ReservationEdge', node?: { __typename?: 'Reservation', id: string } | null }> } };
...
export type GqlGetReservationQuery = { __typename?: 'Query', reservation?: { __typename?: 'Reservation', id: string, status: GqlReservationStatus, opportunitySlot?: { __typename?: 'OpportunitySlot', id: string, hostingStatus: GqlOpportunitySlotHostingStatus, startsAt: Date, endsAt: Date, capacity?: number | null, remainingCapacity?: number | null, opportunity?: { __typename?: 'Opportunity', id: string, title: string, description: string, body?: string | null, images?: Array<string> | null, category: GqlOpportunityCategory, publishStatus: GqlPublishStatus, isReservableWithTicket?: boolean | null, requireApproval: boolean, feeRequired?: number | null, pointsToEarn?: number | null, earliestReservableAt?: Date | null, createdByUser?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null, articlesAboutMe?: Array<{ __typename?: 'Article', id: string, title: string, body?: string | null, introduction: string, thumbnail?: any | null, category: GqlArticleCategory, publishStatus: GqlPublishStatus, publishedAt?: Date | null }> | null } | null, place?: { __typename?: 'Place', id: string, name: string, address: string, latitude: any, longitude: any, city?: { __typename?: 'City', code: string, name: string, state?: { __typename?: 'State', code: string, countryCode: string, name: string } | null } | null } | null } | null } | null, participations?: Array<{ __typename?: 'Participation', id: string, source?: GqlSource | null, status: GqlParticipationStatus, reason: GqlParticipationStatusReason, images?: Array<string> | null, description?: string | null }> | null } | null };

export type GqlPlaceFieldsFragment = { __typename?: 'Place', id: string, name: string, address: string, latitude: any, longitude: any, city?: { __typename?: 'City', code: string, name: string, state?: { __typename?: 'State', code: string, countryCode: string, name: string } | null } | null };

export type GqlGetPlacesQueryVariables = Exact<{ [key: string]: never; }>;


export type GqlGetPlacesQuery = { __typename?: 'Query', places: { __typename?: 'PlacesConnection', totalCount: number, edges?: Array<{ __typename?: 'PlaceEdge', node?: { __typename?: 'Place', id: string, name: string } | null } | null> | null } };

export type GqlTicketFieldsFragment = { __typename?: 'Ticket', id: string, reason: GqlTicketStatusReason, status: GqlTicketStatus };
...
export type GqlTicketClaimMutation = { __typename?: 'Mutation', ticketClaim?: { __typename?: 'TicketClaimSuccess', tickets: Array<{ __typename?: 'Ticket', id: string }> } | null };

export type GqlGetTicketsQueryVariables = Exact<{ [key: string]: never; }>;


export type GqlGetTicketsQuery = { __typename?: 'Query', tickets: { __typename?: 'TicketsConnection', totalCount: number, edges?: Array<{ __typename?: 'TicketEdge', node?: { __typename?: 'Ticket', id: string } | null } | null> | null } };
...
export type GqlGetTicketQuery = { __typename?: 'Query', ticket?: { __typename?: 'Ticket', id: string } | null };

export type GqlTicketClaimLinkFieldsFragment = { __typename?: 'TicketClaimLink', id: string, qty: number, status: GqlClaimLinkStatus, claimedAt?: Date | null };
...
export type GqlTicketClaimLinkQuery = { __typename?: 'Query', ticketClaimLink?: { __typename?: 'TicketClaimLink', qty: number, status: GqlClaimLinkStatus, issuer?: { __typename?: 'TicketIssuer', owner?: { __typename?: 'User', id: string, name: string, image?: string | null } | null } | null } | null };

export type GqlUtilityFieldsFragment = { __typename?: 'Utility', id: string, name?: string | null, description?: string | null, images?: Array<string> | null, publishStatus: GqlPublishStatus, pointsRequired: number };

export type GqlGetUtilitiesQueryVariables = Exact<{ [key: string]: never; }>;


export type GqlGetUtilitiesQuery = { __typename?: 'Query', utilities: { __typename?: 'UtilitiesConnection', totalCount: number, edges?: Array<{ __typename?: 'UtilityEdge', node?: { __typename?: 'Utility', id: string, name?: string | null } | null } | null> | null } };

export type GqlTransactionFieldsFragment = { __typename?: 'Transaction', id: string, reason: GqlTransactionReason, fromPointChange?: number | null, toPointChange?: number | null, createdAt?: Date | null };
...
export type GqlGetTransactionsQuery = { __typename?: 'Query', transactions: { __typename?: 'TransactionsConnection', totalCount: number, pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean, startCursor?: string | null, endCursor?: string | null }, edges?: Array<{ __typename?: 'TransactionEdge', cursor: string, node?: { __typename?: 'Transaction', id: string, reason: GqlTransactionReason, fromPointChange?: number | null, toPointChange?: number | null, createdAt?: Date | null, fromWallet?: { __typename?: 'Wallet', id: string, type: GqlWalletType, user?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null } | null, currentPointView?: { __typename?: 'CurrentPointView', currentPoint: number } | null } | null, toWallet?: { __typename?: 'Wallet', id: string, type: GqlWalletType, user?: { __typename?: 'User', id: string, name: string, image?: string | null, bio?: string | null, currentPrefecture?: GqlCurrentPrefecture | null, urlFacebook?: string | null, urlInstagram?: string | null, urlX?: string | null } | null, currentPointView?: { __typename?: 'CurrentPointView', currentPoint: number } | null } | null } | null } | null> | null } };
...
export type GqlGetTransactionQuery = { __typename?: 'Query', transaction?: { __typename?: 'Transaction', id: string } | null };
 ...
 * });
 */
export function useGetCommunitiesQuery(baseOptions?: Apollo.QueryHookOptions<GqlGetCommunitiesQuery, GqlGetCommunitiesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetCommunitiesQuery, GqlGetCommunitiesQueryVariables>(GetCommunitiesDocument, options);
      }
export function useGetCommunitiesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetCommunitiesQuery, GqlGetCommunitiesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetCommunitiesQuery, GqlGetCommunitiesQueryVariables>(GetCommunitiesDocument, options);
        }
export function useGetCommunitiesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetCommunitiesQuery, GqlGetCommunitiesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetCommunitiesQuery, GqlGetCommunitiesQueryVariables>(GetCommunitiesDocument, options);
        }
...
export type GetCommunitiesQueryResult = Apollo.QueryResult<GqlGetCommunitiesQuery, GqlGetCommunitiesQueryVariables>;
 ...
 * });
 */
export function useGetCommunityQuery(baseOptions: Apollo.QueryHookOptions<GqlGetCommunityQuery, GqlGetCommunityQueryVariables> & ({ variables: GqlGetCommunityQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetCommunityQuery, GqlGetCommunityQueryVariables>(GetCommunityDocument, options);
      }
export function useGetCommunityLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetCommunityQuery, GqlGetCommunityQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetCommunityQuery, GqlGetCommunityQueryVariables>(GetCommunityDocument, options);
        }
export function useGetCommunitySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetCommunityQuery, GqlGetCommunityQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetCommunityQuery, GqlGetCommunityQueryVariables>(GetCommunityDocument, options);
        }
...
export type GetCommunityQueryResult = Apollo.QueryResult<GqlGetCommunityQuery, GqlGetCommunityQueryVariables>;
export const UserSignUpDocument = gql`
  ...
  userSignUp(input: $input) {
    ...
    `;
export type GqlUserSignUpMutationFn = Apollo.MutationFunction<GqlUserSignUpMutation, GqlUserSignUpMutationVariables>;
 ...
 * });
 */
export function useUserSignUpMutation(baseOptions?: Apollo.MutationHookOptions<GqlUserSignUpMutation, GqlUserSignUpMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<GqlUserSignUpMutation, GqlUserSignUpMutationVariables>(UserSignUpDocument, options);
      }
...
export type UserSignUpMutationOptions = Apollo.BaseMutationOptions<GqlUserSignUpMutation, GqlUserSignUpMutationVariables>;
export const StorePhoneAuthTokenDocument = gql`
  ...
  storePhoneAuthToken(input: $input) {
    ...
    `;
export type GqlStorePhoneAuthTokenMutationFn = Apollo.MutationFunction<GqlStorePhoneAuthTokenMutation, GqlStorePhoneAuthTokenMutationVariables>;
 ...
 * });
 */
export function useStorePhoneAuthTokenMutation(baseOptions?: Apollo.MutationHookOptions<GqlStorePhoneAuthTokenMutation, GqlStorePhoneAuthTokenMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<GqlStorePhoneAuthTokenMutation, GqlStorePhoneAuthTokenMutationVariables>(StorePhoneAuthTokenDocument, options);
      }
export type StorePhoneAuthTokenMutationHookResult = ReturnType<typeof useStorePhoneAuthTokenMutation>;
export type StorePhoneAuthTokenMutationResult = Apollo.MutationResult<GqlStorePhoneAuthTokenMutation>;
export type StorePhoneAuthTokenMutationOptions = Apollo.BaseMutationOptions<GqlStorePhoneAuthTokenMutation, GqlStorePhoneAuthTokenMutationVariables>;
export const LinkPhoneAuthDocument = gql`
  ...
  linkPhoneAuth(input: $input, permission: $permission) {
    ...
    `;
export type GqlLinkPhoneAuthMutationFn = Apollo.MutationFunction<GqlLinkPhoneAuthMutation, GqlLinkPhoneAuthMutationVariables>;
 ...
 * });
 */
export function useLinkPhoneAuthMutation(baseOptions?: Apollo.MutationHookOptions<GqlLinkPhoneAuthMutation, GqlLinkPhoneAuthMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<GqlLinkPhoneAuthMutation, GqlLinkPhoneAuthMutationVariables>(LinkPhoneAuthDocument, options);
      }
...
export type LinkPhoneAuthMutationOptions = Apollo.BaseMutationOptions<GqlLinkPhoneAuthMutation, GqlLinkPhoneAuthMutationVariables>;
...
export function useCurrentUserSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlCurrentUserQuery, GqlCurrentUserQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlCurrentUserQuery, GqlCurrentUserQueryVariables>(CurrentUserDocument, options);
        }
 ...
 * });
 */
export function useGetSingleMembershipQuery(baseOptions: Apollo.QueryHookOptions<GqlGetSingleMembershipQuery, GqlGetSingleMembershipQueryVariables> & ({ variables: GqlGetSingleMembershipQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetSingleMembershipQuery, GqlGetSingleMembershipQueryVariables>(GetSingleMembershipDocument, options);
      }
export function useGetSingleMembershipLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetSingleMembershipQuery, GqlGetSingleMembershipQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetSingleMembershipQuery, GqlGetSingleMembershipQueryVariables>(GetSingleMembershipDocument, options);
        }
export function useGetSingleMembershipSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetSingleMembershipQuery, GqlGetSingleMembershipQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetSingleMembershipQuery, GqlGetSingleMembershipQueryVariables>(GetSingleMembershipDocument, options);
        }
export type GetSingleMembershipQueryHookResult = ReturnType<typeof useGetSingleMembershipQuery>;
export type GetSingleMembershipLazyQueryHookResult = ReturnType<typeof useGetSingleMembershipLazyQuery>;
export type GetSingleMembershipSuspenseQueryHookResult = ReturnType<typeof useGetSingleMembershipSuspenseQuery>;
export type GetSingleMembershipQueryResult = Apollo.QueryResult<GqlGetSingleMembershipQuery, GqlGetSingleMembershipQueryVariables>;
export const GetMembershipListDocument = gql`
    query GetMembershipList($first: Int, $cursor: MembershipCursorInput, $filter: MembershipFilterInput, $sort: MembershipSortInput, $IsCard: Boolean! = false) {
 ...
 * });
 */
export function useGetMembershipListQuery(baseOptions?: Apollo.QueryHookOptions<GqlGetMembershipListQuery, GqlGetMembershipListQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetMembershipListQuery, GqlGetMembershipListQueryVariables>(GetMembershipListDocument, options);
      }
export function useGetMembershipListLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetMembershipListQuery, GqlGetMembershipListQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetMembershipListQuery, GqlGetMembershipListQueryVariables>(GetMembershipListDocument, options);
        }
export function useGetMembershipListSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetMembershipListQuery, GqlGetMembershipListQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetMembershipListQuery, GqlGetMembershipListQueryVariables>(GetMembershipListDocument, options);
        }
...
export type GetMembershipListSuspenseQueryHookResult = ReturnType<typeof useGetMembershipListSuspenseQuery>;
export type GetMembershipListQueryResult = Apollo.QueryResult<GqlGetMembershipListQuery, GqlGetMembershipListQueryVariables>;
export const UpdateMyProfileDocument = gql`
  ...
  userUpdateMyProfile(input: $input, permission: $permission) {
    ...
    `;
export type GqlUpdateMyProfileMutationFn = Apollo.MutationFunction<GqlUpdateMyProfileMutation, GqlUpdateMyProfileMutationVariables>;
 ...
 * });
 */
export function useUpdateMyProfileMutation(baseOptions?: Apollo.MutationHookOptions<GqlUpdateMyProfileMutation, GqlUpdateMyProfileMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<GqlUpdateMyProfileMutation, GqlUpdateMyProfileMutationVariables>(UpdateMyProfileDocument, options);
      }
...
export type UpdateMyProfileMutationOptions = Apollo.BaseMutationOptions<GqlUpdateMyProfileMutation, GqlUpdateMyProfileMutationVariables>;
export const GetUserFlexibleDocument = gql`
    query GetUserFlexible($id: ID!, $withPortfolios: Boolean! = false, $withWallets: Boolean! = false, $withOpportunities: Boolean! = false) {
  user(id: $id) {
    ...UserFields
 ...
 * });
 */
export function useGetUserFlexibleQuery(baseOptions: Apollo.QueryHookOptions<GqlGetUserFlexibleQuery, GqlGetUserFlexibleQueryVariables> & ({ variables: GqlGetUserFlexibleQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetUserFlexibleQuery, GqlGetUserFlexibleQueryVariables>(GetUserFlexibleDocument, options);
      }
export function useGetUserFlexibleLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetUserFlexibleQuery, GqlGetUserFlexibleQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetUserFlexibleQuery, GqlGetUserFlexibleQueryVariables>(GetUserFlexibleDocument, options);
        }
export function useGetUserFlexibleSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetUserFlexibleQuery, GqlGetUserFlexibleQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetUserFlexibleQuery, GqlGetUserFlexibleQueryVariables>(GetUserFlexibleDocument, options);
        }
...
export type GetUserFlexibleSuspenseQueryHookResult = ReturnType<typeof useGetUserFlexibleSuspenseQuery>;
export type GetUserFlexibleQueryResult = Apollo.QueryResult<GqlGetUserFlexibleQuery, GqlGetUserFlexibleQueryVariables>;
 ...
 * });
 */
export function useGetUserWalletQuery(baseOptions: Apollo.QueryHookOptions<GqlGetUserWalletQuery, GqlGetUserWalletQueryVariables> & ({ variables: GqlGetUserWalletQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetUserWalletQuery, GqlGetUserWalletQueryVariables>(GetUserWalletDocument, options);
      }
export function useGetUserWalletLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetUserWalletQuery, GqlGetUserWalletQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetUserWalletQuery, GqlGetUserWalletQueryVariables>(GetUserWalletDocument, options);
        }
export function useGetUserWalletSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetUserWalletQuery, GqlGetUserWalletQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetUserWalletQuery, GqlGetUserWalletQueryVariables>(GetUserWalletDocument, options);
        }
...
export type GetUserWalletQueryResult = Apollo.QueryResult<GqlGetUserWalletQuery, GqlGetUserWalletQueryVariables>;
 ...
 * });
 */
export function useGetWalletsWithTransactionQuery(baseOptions?: Apollo.QueryHookOptions<GqlGetWalletsWithTransactionQuery, GqlGetWalletsWithTransactionQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetWalletsWithTransactionQuery, GqlGetWalletsWithTransactionQueryVariables>(GetWalletsWithTransactionDocument, options);
      }
export function useGetWalletsWithTransactionLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetWalletsWithTransactionQuery, GqlGetWalletsWithTransactionQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetWalletsWithTransactionQuery, GqlGetWalletsWithTransactionQueryVariables>(GetWalletsWithTransactionDocument, options);
        }
export function useGetWalletsWithTransactionSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetWalletsWithTransactionQuery, GqlGetWalletsWithTransactionQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetWalletsWithTransactionQuery, GqlGetWalletsWithTransactionQueryVariables>(GetWalletsWithTransactionDocument, options);
        }
export type GetWalletsWithTransactionQueryHookResult = ReturnType<typeof useGetWalletsWithTransactionQuery>;
export type GetWalletsWithTransactionLazyQueryHookResult = ReturnType<typeof useGetWalletsWithTransactionLazyQuery>;
export type GetWalletsWithTransactionSuspenseQueryHookResult = ReturnType<typeof useGetWalletsWithTransactionSuspenseQuery>;
export type GetWalletsWithTransactionQueryResult = Apollo.QueryResult<GqlGetWalletsWithTransactionQuery, GqlGetWalletsWithTransactionQueryVariables>;
 ...
 * });
 */
export function useGetWalletsWithTicketQuery(baseOptions?: Apollo.QueryHookOptions<GqlGetWalletsWithTicketQuery, GqlGetWalletsWithTicketQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetWalletsWithTicketQuery, GqlGetWalletsWithTicketQueryVariables>(GetWalletsWithTicketDocument, options);
      }
export function useGetWalletsWithTicketLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetWalletsWithTicketQuery, GqlGetWalletsWithTicketQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetWalletsWithTicketQuery, GqlGetWalletsWithTicketQueryVariables>(GetWalletsWithTicketDocument, options);
        }
export function useGetWalletsWithTicketSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetWalletsWithTicketQuery, GqlGetWalletsWithTicketQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetWalletsWithTicketQuery, GqlGetWalletsWithTicketQueryVariables>(GetWalletsWithTicketDocument, options);
        }
export type GetWalletsWithTicketQueryHookResult = ReturnType<typeof useGetWalletsWithTicketQuery>;
export type GetWalletsWithTicketLazyQueryHookResult = ReturnType<typeof useGetWalletsWithTicketLazyQuery>;
export type GetWalletsWithTicketSuspenseQueryHookResult = ReturnType<typeof useGetWalletsWithTicketSuspenseQuery>;
export type GetWalletsWithTicketQueryResult = Apollo.QueryResult<GqlGetWalletsWithTicketQuery, GqlGetWalletsWithTicketQueryVariables>;
 ...
 * });
 */
export function useGetArticlesQuery(baseOptions?: Apollo.QueryHookOptions<GqlGetArticlesQuery, GqlGetArticlesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetArticlesQuery, GqlGetArticlesQueryVariables>(GetArticlesDocument, options);
      }
export function useGetArticlesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetArticlesQuery, GqlGetArticlesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetArticlesQuery, GqlGetArticlesQueryVariables>(GetArticlesDocument, options);
        }
export function useGetArticlesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetArticlesQuery, GqlGetArticlesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetArticlesQuery, GqlGetArticlesQueryVariables>(GetArticlesDocument, options);
        }
...
export type GetArticlesQueryResult = Apollo.QueryResult<GqlGetArticlesQuery, GqlGetArticlesQueryVariables>;
 ...
 * });
 */
export function useGetArticleQuery(baseOptions: Apollo.QueryHookOptions<GqlGetArticleQuery, GqlGetArticleQueryVariables> & ({ variables: GqlGetArticleQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetArticleQuery, GqlGetArticleQueryVariables>(GetArticleDocument, options);
      }
export function useGetArticleLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetArticleQuery, GqlGetArticleQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetArticleQuery, GqlGetArticleQueryVariables>(GetArticleDocument, options);
        }
export function useGetArticleSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetArticleQuery, GqlGetArticleQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetArticleQuery, GqlGetArticleQueryVariables>(GetArticleDocument, options);
        }
...
export type GetArticleQueryResult = Apollo.QueryResult<GqlGetArticleQuery, GqlGetArticleQueryVariables>;
 ...
 * });
 */
export function useGetEvaluationsQuery(baseOptions?: Apollo.QueryHookOptions<GqlGetEvaluationsQuery, GqlGetEvaluationsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetEvaluationsQuery, GqlGetEvaluationsQueryVariables>(GetEvaluationsDocument, options);
      }
export function useGetEvaluationsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetEvaluationsQuery, GqlGetEvaluationsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetEvaluationsQuery, GqlGetEvaluationsQueryVariables>(GetEvaluationsDocument, options);
        }
export function useGetEvaluationsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetEvaluationsQuery, GqlGetEvaluationsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetEvaluationsQuery, GqlGetEvaluationsQueryVariables>(GetEvaluationsDocument, options);
        }
...
export type GetEvaluationsSuspenseQueryHookResult = ReturnType<typeof useGetEvaluationsSuspenseQuery>;
export type GetEvaluationsQueryResult = Apollo.QueryResult<GqlGetEvaluationsQuery, GqlGetEvaluationsQueryVariables>;
 ...
 * });
 */
export function useGetEvaluationQuery(baseOptions: Apollo.QueryHookOptions<GqlGetEvaluationQuery, GqlGetEvaluationQueryVariables> & ({ variables: GqlGetEvaluationQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetEvaluationQuery, GqlGetEvaluationQueryVariables>(GetEvaluationDocument, options);
      }
export function useGetEvaluationLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetEvaluationQuery, GqlGetEvaluationQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetEvaluationQuery, GqlGetEvaluationQueryVariables>(GetEvaluationDocument, options);
        }
export function useGetEvaluationSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetEvaluationQuery, GqlGetEvaluationQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetEvaluationQuery, GqlGetEvaluationQueryVariables>(GetEvaluationDocument, options);
        }
...
export type GetEvaluationQueryResult = Apollo.QueryResult<GqlGetEvaluationQuery, GqlGetEvaluationQueryVariables>;
 ...
 * });
 */
export function useGetOpportunitiesQuery(baseOptions?: Apollo.QueryHookOptions<GqlGetOpportunitiesQuery, GqlGetOpportunitiesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetOpportunitiesQuery, GqlGetOpportunitiesQueryVariables>(GetOpportunitiesDocument, options);
      }
export function useGetOpportunitiesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetOpportunitiesQuery, GqlGetOpportunitiesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetOpportunitiesQuery, GqlGetOpportunitiesQueryVariables>(GetOpportunitiesDocument, options);
        }
export function useGetOpportunitiesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetOpportunitiesQuery, GqlGetOpportunitiesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetOpportunitiesQuery, GqlGetOpportunitiesQueryVariables>(GetOpportunitiesDocument, options);
        }
...
export type GetOpportunitiesQueryResult = Apollo.QueryResult<GqlGetOpportunitiesQuery, GqlGetOpportunitiesQueryVariables>;
 ...
 * });
 */
export function useGetOpportunityQuery(baseOptions: Apollo.QueryHookOptions<GqlGetOpportunityQuery, GqlGetOpportunityQueryVariables> & ({ variables: GqlGetOpportunityQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetOpportunityQuery, GqlGetOpportunityQueryVariables>(GetOpportunityDocument, options);
      }
export function useGetOpportunityLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetOpportunityQuery, GqlGetOpportunityQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetOpportunityQuery, GqlGetOpportunityQueryVariables>(GetOpportunityDocument, options);
        }
export function useGetOpportunitySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetOpportunityQuery, GqlGetOpportunityQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetOpportunityQuery, GqlGetOpportunityQueryVariables>(GetOpportunityDocument, options);
        }
...
export type GetOpportunityQueryResult = Apollo.QueryResult<GqlGetOpportunityQuery, GqlGetOpportunityQueryVariables>;
 ...
 * });
 */
export function useSearchOpportunitiesQuery(baseOptions?: Apollo.QueryHookOptions<GqlSearchOpportunitiesQuery, GqlSearchOpportunitiesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlSearchOpportunitiesQuery, GqlSearchOpportunitiesQueryVariables>(SearchOpportunitiesDocument, options);
      }
export function useSearchOpportunitiesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlSearchOpportunitiesQuery, GqlSearchOpportunitiesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlSearchOpportunitiesQuery, GqlSearchOpportunitiesQueryVariables>(SearchOpportunitiesDocument, options);
        }
export function useSearchOpportunitiesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlSearchOpportunitiesQuery, GqlSearchOpportunitiesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlSearchOpportunitiesQuery, GqlSearchOpportunitiesQueryVariables>(SearchOpportunitiesDocument, options);
        }
export type SearchOpportunitiesQueryHookResult = ReturnType<typeof useSearchOpportunitiesQuery>;
export type SearchOpportunitiesLazyQueryHookResult = ReturnType<typeof useSearchOpportunitiesLazyQuery>;
export type SearchOpportunitiesSuspenseQueryHookResult = ReturnType<typeof useSearchOpportunitiesSuspenseQuery>;
export type SearchOpportunitiesQueryResult = Apollo.QueryResult<GqlSearchOpportunitiesQuery, GqlSearchOpportunitiesQueryVariables>;
 ...
 * });
 */
export function useGetOpportunitySlotsQuery(baseOptions?: Apollo.QueryHookOptions<GqlGetOpportunitySlotsQuery, GqlGetOpportunitySlotsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetOpportunitySlotsQuery, GqlGetOpportunitySlotsQueryVariables>(GetOpportunitySlotsDocument, options);
      }
export function useGetOpportunitySlotsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetOpportunitySlotsQuery, GqlGetOpportunitySlotsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetOpportunitySlotsQuery, GqlGetOpportunitySlotsQueryVariables>(GetOpportunitySlotsDocument, options);
        }
export function useGetOpportunitySlotsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetOpportunitySlotsQuery, GqlGetOpportunitySlotsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetOpportunitySlotsQuery, GqlGetOpportunitySlotsQueryVariables>(GetOpportunitySlotsDocument, options);
        }
export type GetOpportunitySlotsQueryHookResult = ReturnType<typeof useGetOpportunitySlotsQuery>;
export type GetOpportunitySlotsLazyQueryHookResult = ReturnType<typeof useGetOpportunitySlotsLazyQuery>;
export type GetOpportunitySlotsSuspenseQueryHookResult = ReturnType<typeof useGetOpportunitySlotsSuspenseQuery>;
export type GetOpportunitySlotsQueryResult = Apollo.QueryResult<GqlGetOpportunitySlotsQuery, GqlGetOpportunitySlotsQueryVariables>;
 ...
 * });
 */
export function useGetOpportunitySlotQuery(baseOptions: Apollo.QueryHookOptions<GqlGetOpportunitySlotQuery, GqlGetOpportunitySlotQueryVariables> & ({ variables: GqlGetOpportunitySlotQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetOpportunitySlotQuery, GqlGetOpportunitySlotQueryVariables>(GetOpportunitySlotDocument, options);
      }
export function useGetOpportunitySlotLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetOpportunitySlotQuery, GqlGetOpportunitySlotQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetOpportunitySlotQuery, GqlGetOpportunitySlotQueryVariables>(GetOpportunitySlotDocument, options);
        }
export function useGetOpportunitySlotSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetOpportunitySlotQuery, GqlGetOpportunitySlotQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetOpportunitySlotQuery, GqlGetOpportunitySlotQueryVariables>(GetOpportunitySlotDocument, options);
        }
export type GetOpportunitySlotQueryHookResult = ReturnType<typeof useGetOpportunitySlotQuery>;
export type GetOpportunitySlotLazyQueryHookResult = ReturnType<typeof useGetOpportunitySlotLazyQuery>;
export type GetOpportunitySlotSuspenseQueryHookResult = ReturnType<typeof useGetOpportunitySlotSuspenseQuery>;
export type GetOpportunitySlotQueryResult = Apollo.QueryResult<GqlGetOpportunitySlotQuery, GqlGetOpportunitySlotQueryVariables>;
 ...
 * });
 */
export function useGetParticipationsQuery(baseOptions?: Apollo.QueryHookOptions<GqlGetParticipationsQuery, GqlGetParticipationsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetParticipationsQuery, GqlGetParticipationsQueryVariables>(GetParticipationsDocument, options);
      }
export function useGetParticipationsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetParticipationsQuery, GqlGetParticipationsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetParticipationsQuery, GqlGetParticipationsQueryVariables>(GetParticipationsDocument, options);
        }
export function useGetParticipationsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetParticipationsQuery, GqlGetParticipationsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetParticipationsQuery, GqlGetParticipationsQueryVariables>(GetParticipationsDocument, options);
        }
...
export type GetParticipationsSuspenseQueryHookResult = ReturnType<typeof useGetParticipationsSuspenseQuery>;
export type GetParticipationsQueryResult = Apollo.QueryResult<GqlGetParticipationsQuery, GqlGetParticipationsQueryVariables>;
 ...
 * });
 */
export function useGetParticipationQuery(baseOptions: Apollo.QueryHookOptions<GqlGetParticipationQuery, GqlGetParticipationQueryVariables> & ({ variables: GqlGetParticipationQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetParticipationQuery, GqlGetParticipationQueryVariables>(GetParticipationDocument, options);
      }
export function useGetParticipationLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetParticipationQuery, GqlGetParticipationQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetParticipationQuery, GqlGetParticipationQueryVariables>(GetParticipationDocument, options);
        }
export function useGetParticipationSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetParticipationQuery, GqlGetParticipationQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetParticipationQuery, GqlGetParticipationQueryVariables>(GetParticipationDocument, options);
        }
...
export type GetParticipationSuspenseQueryHookResult = ReturnType<typeof useGetParticipationSuspenseQuery>;
export type GetParticipationQueryResult = Apollo.QueryResult<GqlGetParticipationQuery, GqlGetParticipationQueryVariables>;
export const CreateReservationDocument = gql`
  ...
  reservationCreate(input: $input) {
    ...
    ${ReservationFieldsFragmentDoc}`;
export type GqlCreateReservationMutationFn = Apollo.MutationFunction<GqlCreateReservationMutation, GqlCreateReservationMutationVariables>;
 ...
 * });
 */
export function useCreateReservationMutation(baseOptions?: Apollo.MutationHookOptions<GqlCreateReservationMutation, GqlCreateReservationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<GqlCreateReservationMutation, GqlCreateReservationMutationVariables>(CreateReservationDocument, options);
      }
...
export type CreateReservationMutationOptions = Apollo.BaseMutationOptions<GqlCreateReservationMutation, GqlCreateReservationMutationVariables>;
export const CancelReservationDocument = gql`
    mutation CancelReservation($id: ID!, $input: ReservationCancelInput!, $permission: CheckIsSelfPermissionInput!) {
  reservationCancel(id: $id, input: $input, permission: $permission) {
    ...
    ${ReservationFieldsFragmentDoc}`;
export type GqlCancelReservationMutationFn = Apollo.MutationFunction<GqlCancelReservationMutation, GqlCancelReservationMutationVariables>;
 ...
 * });
 */
export function useCancelReservationMutation(baseOptions?: Apollo.MutationHookOptions<GqlCancelReservationMutation, GqlCancelReservationMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<GqlCancelReservationMutation, GqlCancelReservationMutationVariables>(CancelReservationDocument, options);
      }
...
export type CancelReservationMutationOptions = Apollo.BaseMutationOptions<GqlCancelReservationMutation, GqlCancelReservationMutationVariables>;
 ...
 * });
 */
export function useGetReservationsQuery(baseOptions?: Apollo.QueryHookOptions<GqlGetReservationsQuery, GqlGetReservationsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetReservationsQuery, GqlGetReservationsQueryVariables>(GetReservationsDocument, options);
      }
export function useGetReservationsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetReservationsQuery, GqlGetReservationsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetReservationsQuery, GqlGetReservationsQueryVariables>(GetReservationsDocument, options);
        }
export function useGetReservationsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetReservationsQuery, GqlGetReservationsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetReservationsQuery, GqlGetReservationsQueryVariables>(GetReservationsDocument, options);
        }
...
export type GetReservationsQueryResult = Apollo.QueryResult<GqlGetReservationsQuery, GqlGetReservationsQueryVariables>;
 ...
 * });
 */
export function useGetReservationQuery(baseOptions: Apollo.QueryHookOptions<GqlGetReservationQuery, GqlGetReservationQueryVariables> & ({ variables: GqlGetReservationQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetReservationQuery, GqlGetReservationQueryVariables>(GetReservationDocument, options);
      }
export function useGetReservationLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetReservationQuery, GqlGetReservationQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetReservationQuery, GqlGetReservationQueryVariables>(GetReservationDocument, options);
        }
export function useGetReservationSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetReservationQuery, GqlGetReservationQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetReservationQuery, GqlGetReservationQueryVariables>(GetReservationDocument, options);
        }
...
export type GetReservationSuspenseQueryHookResult = ReturnType<typeof useGetReservationSuspenseQuery>;
export type GetReservationQueryResult = Apollo.QueryResult<GqlGetReservationQuery, GqlGetReservationQueryVariables>;
 ...
 * });
 */
export function useGetPlacesQuery(baseOptions?: Apollo.QueryHookOptions<GqlGetPlacesQuery, GqlGetPlacesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetPlacesQuery, GqlGetPlacesQueryVariables>(GetPlacesDocument, options);
      }
export function useGetPlacesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetPlacesQuery, GqlGetPlacesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetPlacesQuery, GqlGetPlacesQueryVariables>(GetPlacesDocument, options);
        }
export function useGetPlacesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetPlacesQuery, GqlGetPlacesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetPlacesQuery, GqlGetPlacesQueryVariables>(GetPlacesDocument, options);
        }
...
export type GetPlacesQueryResult = Apollo.QueryResult<GqlGetPlacesQuery, GqlGetPlacesQueryVariables>;
export const TicketClaimDocument = gql`
  ...
  ticketClaim(input: $input) {
    ...
    `;
export type GqlTicketClaimMutationFn = Apollo.MutationFunction<GqlTicketClaimMutation, GqlTicketClaimMutationVariables>;
 ...
 * });
 */
export function useTicketClaimMutation(baseOptions?: Apollo.MutationHookOptions<GqlTicketClaimMutation, GqlTicketClaimMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<GqlTicketClaimMutation, GqlTicketClaimMutationVariables>(TicketClaimDocument, options);
      }
...
export type TicketClaimMutationOptions = Apollo.BaseMutationOptions<GqlTicketClaimMutation, GqlTicketClaimMutationVariables>;
 ...
 * });
 */
export function useGetTicketsQuery(baseOptions?: Apollo.QueryHookOptions<GqlGetTicketsQuery, GqlGetTicketsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetTicketsQuery, GqlGetTicketsQueryVariables>(GetTicketsDocument, options);
      }
export function useGetTicketsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetTicketsQuery, GqlGetTicketsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetTicketsQuery, GqlGetTicketsQueryVariables>(GetTicketsDocument, options);
        }
export function useGetTicketsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetTicketsQuery, GqlGetTicketsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetTicketsQuery, GqlGetTicketsQueryVariables>(GetTicketsDocument, options);
        }
...
export type GetTicketsQueryResult = Apollo.QueryResult<GqlGetTicketsQuery, GqlGetTicketsQueryVariables>;
 ...
 * });
 */
export function useGetTicketQuery(baseOptions: Apollo.QueryHookOptions<GqlGetTicketQuery, GqlGetTicketQueryVariables> & ({ variables: GqlGetTicketQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetTicketQuery, GqlGetTicketQueryVariables>(GetTicketDocument, options);
      }
export function useGetTicketLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetTicketQuery, GqlGetTicketQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetTicketQuery, GqlGetTicketQueryVariables>(GetTicketDocument, options);
        }
export function useGetTicketSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetTicketQuery, GqlGetTicketQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetTicketQuery, GqlGetTicketQueryVariables>(GetTicketDocument, options);
        }
...
export type GetTicketQueryResult = Apollo.QueryResult<GqlGetTicketQuery, GqlGetTicketQueryVariables>;
 ...
 * });
 */
export function useTicketClaimLinkQuery(baseOptions: Apollo.QueryHookOptions<GqlTicketClaimLinkQuery, GqlTicketClaimLinkQueryVariables> & ({ variables: GqlTicketClaimLinkQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlTicketClaimLinkQuery, GqlTicketClaimLinkQueryVariables>(TicketClaimLinkDocument, options);
      }
export function useTicketClaimLinkLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlTicketClaimLinkQuery, GqlTicketClaimLinkQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlTicketClaimLinkQuery, GqlTicketClaimLinkQueryVariables>(TicketClaimLinkDocument, options);
        }
export function useTicketClaimLinkSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlTicketClaimLinkQuery, GqlTicketClaimLinkQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlTicketClaimLinkQuery, GqlTicketClaimLinkQueryVariables>(TicketClaimLinkDocument, options);
        }
...
export type TicketClaimLinkSuspenseQueryHookResult = ReturnType<typeof useTicketClaimLinkSuspenseQuery>;
export type TicketClaimLinkQueryResult = Apollo.QueryResult<GqlTicketClaimLinkQuery, GqlTicketClaimLinkQueryVariables>;
 ...
 * });
 */
export function useGetUtilitiesQuery(baseOptions?: Apollo.QueryHookOptions<GqlGetUtilitiesQuery, GqlGetUtilitiesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetUtilitiesQuery, GqlGetUtilitiesQueryVariables>(GetUtilitiesDocument, options);
      }
export function useGetUtilitiesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetUtilitiesQuery, GqlGetUtilitiesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetUtilitiesQuery, GqlGetUtilitiesQueryVariables>(GetUtilitiesDocument, options);
        }
export function useGetUtilitiesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetUtilitiesQuery, GqlGetUtilitiesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetUtilitiesQuery, GqlGetUtilitiesQueryVariables>(GetUtilitiesDocument, options);
        }
...
export type GetUtilitiesQueryResult = Apollo.QueryResult<GqlGetUtilitiesQuery, GqlGetUtilitiesQueryVariables>;
 ...
 * });
 */
export function useGetTransactionsQuery(baseOptions?: Apollo.QueryHookOptions<GqlGetTransactionsQuery, GqlGetTransactionsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetTransactionsQuery, GqlGetTransactionsQueryVariables>(GetTransactionsDocument, options);
      }
export function useGetTransactionsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetTransactionsQuery, GqlGetTransactionsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetTransactionsQuery, GqlGetTransactionsQueryVariables>(GetTransactionsDocument, options);
        }
export function useGetTransactionsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetTransactionsQuery, GqlGetTransactionsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetTransactionsQuery, GqlGetTransactionsQueryVariables>(GetTransactionsDocument, options);
        }
...
export type GetTransactionsQueryResult = Apollo.QueryResult<GqlGetTransactionsQuery, GqlGetTransactionsQueryVariables>;
 ...
 * });
 */
export function useGetTransactionQuery(baseOptions: Apollo.QueryHookOptions<GqlGetTransactionQuery, GqlGetTransactionQueryVariables> & ({ variables: GqlGetTransactionQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GqlGetTransactionQuery, GqlGetTransactionQueryVariables>(GetTransactionDocument, options);
      }
export function useGetTransactionLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GqlGetTransactionQuery, GqlGetTransactionQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GqlGetTransactionQuery, GqlGetTransactionQueryVariables>(GetTransactionDocument, options);
        }
export function useGetTransactionSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GqlGetTransactionQuery, GqlGetTransactionQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GqlGetTransactionQuery, GqlGetTransactionQueryVariables>(GetTransactionDocument, options);
        }
...
export type GetTransactionQueryResult = Apollo.QueryResult<GqlGetTransactionQuery, GqlGetTransactionQueryVariables>;