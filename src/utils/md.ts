export const proseClassName = `
  ...
  prose-table:table-auto prose-table:min-w-[800px] prose-table:border prose-table:border-collapse prose-table:text-left prose-table:my-4
  prose-th:bg-gray-100 prose-th:font-semibold prose-th:text-gray-800 prose-th:p-2
  prose-td:p-2
\`;
`;
