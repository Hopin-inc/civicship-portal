import { WalletOverview } from "@/app/(authed)/wallets/features/overview/WalletOverview";
import { TransactionList } from "@/app/(authed)/wallets/features/transactions/TransactionList";
