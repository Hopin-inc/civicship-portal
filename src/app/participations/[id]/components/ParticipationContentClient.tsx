...
import { NotificationMessage } from "@/app/participations/[id]/components/NotificationMessage";
...
import { ParticipationImageGallery } from "@/app/participations/[id]/components/ParticipationImageGallery";
...
export const ParticipationContentClient = ({
  ...
  return (
    <>
      {uploadSuccess && (
        <NotificationMessage type="success" title="写真が正常にアップロードされました" />
      )}
      ...
      {participation?.node?.images?.length > 0 && (
        <ParticipationImageGallery images={participation.node.images} />
      )}
