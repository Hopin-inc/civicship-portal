    ...
    <Card className="w-full max-w-md mx-auto">
      <CardContent className="p-0">
            ...
            {COMMUNITY_ID === 'kibotcha' && (
              <>
                <a href="/communities/kibotcha/token-regulations.pdf" target="_blank" rel="noopener noreferrer">
                  <div className="flex items-center justify-between py-4 px-4 border-b">
                    <div className="flex items-center gap-2">
                      <FileIcon className="w-5 h-5" />
                ...
                <a href="/communities/kibotcha/dao-meeting-rules.pdf" target="_blank" rel="noopener noreferrer">
                  <div className="flex items-center justify-between py-4 px-4 border-b">
                    <div className="flex items-center gap-2">
                      <FileIcon className="w-5 h-5" />
                ...
                <a href="/communities/kibotcha/whitepaper.pdf" target="_blank" rel="noopener noreferrer">
                  <div className="flex items-center justify-between py-4 px-4 border-b">
                    <div className="flex items-center gap-2">
                      <FileIcon className="w-5 h-5" />
