...
export const PendingCard = ({ description }: { description: string }) => (
    <div className="border border-[#EAB308] bg-[#FEFCE8] rounded-2xl p-4 flex flex-col gap-2">
      <div className="flex items-start">
        <div>
          <AlertCircle className="text-[#EAB308] w-5 h-5 mr-2 mt-[0.7px]" />
        </div>
        <div>
...
export const ErrorCard = ({ description }: { description: string }) => (
  <div className="border border-[#F87171] bg-[#FEF2F2] rounded-2xl p-4">
    <div className="flex items-start">
      <div>
