...
import { GqlUser, GqlParticipationStatusReason, GqlVcIssuanceStatus, GqlDidIssuanceStatus, GqlGetDidIssuanceRequestsQuery, GqlGetVcIssuanceRequestsByUserQuery } from "@/types/graphql";
