...
const hiddenAdminBottomBarPaths = ["/admin/credentials", "/admin/wallet", "/admin/members"];
...
const MainContent: React.FC<MainContentProps> = ({ children }) => {
  ...
  const hideAdminBottomBar = hiddenAdminBottomBarPaths.some((path) => pathname.includes(path));
