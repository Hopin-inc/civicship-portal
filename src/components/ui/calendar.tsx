...
function Calendar({
  ...
  const dateFnsLocale = currentLocale === 'ja' ? ja : enUS;
  ...
  return (
    <DayPicker
      ...
      formatters={{
        formatMonthDropdown: (date) => date.toLocaleString(currentLocale, { month: "short" }),
        ...formatters,
      }}
      classNames={{
        ...
        today: cn(
          "bg-muted text-primary-foreground rounded-md data-[selected=true]:rounded-none",
