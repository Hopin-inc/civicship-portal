...
export default function FeaturedSectionSkeleton() {
  return (
    <section className="relative h-[70vh] mt-0 w-full overflow-hidden">
      {/* 上部見出しエリア */}
      <div className="absolute inset-x-0 top-0 z-10 bg-gradient-to-b from-black/60 to-transparent py-10 px-6">
