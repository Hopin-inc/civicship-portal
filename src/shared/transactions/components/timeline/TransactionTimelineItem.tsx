  ...
  const content = (
    <div className="relative flex gap-3 pb-6 timeline-item">
      ...
      <div className="relative flex flex-col items-center">
        {/* 上側の線（CSSで制御） */}
        <div className="absolute top-0 bottom-1/2 w-0.5 bg-zinc-300 timeline-rail-top" />
        ...
        {/* 下側の線（CSSで制御） */}
        <div className="absolute top-1/2 bottom-0 w-0.5 bg-zinc-300 timeline-rail-bottom" />
      </div>
