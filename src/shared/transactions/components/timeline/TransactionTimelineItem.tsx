  ...
  const content = (
    <div className="relative flex gap-3 pb-6 timeline-item">
      ...
      <div className="relative flex flex-col items-center self-stretch">
        {/* 上側の線 - アイテム上端からAvatar中心（24px）まで */}
        <div className="absolute left-1/2 top-0 h-6 w-0.5 -ml-px bg-zinc-300 timeline-rail-top" />
        ...
        {/* 下側の線 - Avatar中心（24px）からアイテム下端まで */}
        <div className="absolute left-1/2 top-6 bottom-0 w-0.5 -ml-px bg-zinc-300 timeline-rail-bottom" />
      </div>
