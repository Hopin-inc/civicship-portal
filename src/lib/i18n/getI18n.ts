...
export const getI18n = cache(getI18nRaw);

export const getLocale = cache(async () => (await getI18n()).locale);

export const getMessages = cache(async () => (await getI18n()).messages);
