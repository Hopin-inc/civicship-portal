    ...
    documents: [
      {
        ...
        title: "コミュニティガイドライン (PDF)",
        path: "/communities/izu/community-guidelines.pdf",
        type: "external",
        order: 1,
      },
      {
        id: "point-system-rules",
        title: "ポイント制度規程 (PDF)",
        path: "/communities/izu/point-system-rules.pdf",
        type: "external",
        order: 2,
      },
      {
        id: "dao-participation-guide",
        title: "DAO参加ガイド (PDF)",
        path: "/communities/izu/dao-participation-guide.pdf",
        type: "external",
        order: 3,
      },
    ],
